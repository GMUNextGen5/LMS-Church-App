...
function buildPrivacyPolicyHtml(): string {
  return `
<section class="mb-6">
  <h4 class="text-base font-semibold text-on-surface mb-2">Introduction</h4>
  <p class="text-on-surface-muted leading-relaxed">DSKM LMS is dedicated to protecting the privacy of students and teachers. We want you to understand what we collect, why we collect it, and how we keep it safe.</p>
</section>
<section class="mb-6">
  <h4 class="text-base font-semibold text-on-surface mb-2">Data collection</h4>
  <p class="text-on-surface-muted leading-relaxed">We collect information needed to run the learning platform. That may include names, email addresses, academic grades, attendance records, and logs of interactions with the AI Assistant (so we can improve guidance and support).</p>
</section>
<section class="mb-6">
  <h4 class="text-base font-semibold text-on-surface mb-2">How we use your information</h4>
  <p class="text-on-surface-muted leading-relaxed">We use this information strictly for educational purposes: supporting teaching and learning, grade tracking, attendance, and improving AI-driven insights that help you study. <strong class="font-semibold text-on-surface">We never sell your data to third parties.</strong></p>
</section>
<section class="mb-6">
  <h4 class="text-base font-semibold text-on-surface mb-2">Security</h4>
  <p class="text-on-surface-muted leading-relaxed">We use industry-standard encryption and sensible safeguards to help keep your academic records and account information protected.</p>
</section>
<section class="mb-0">
  <h4 class="text-base font-semibold text-on-surface mb-2">Your rights</h4>
  <p class="text-on-surface-muted leading-relaxed">You have the right to view your own data where the platform allows it, and to request corrections if something in your records looks wrong. Reach out to your teacher or school administrator for help with corrections.</p>
</section>`;
}
...
function buildTermsOfServiceHtml(): string {
  return `
<section class="mb-6">
  <h4 class="text-base font-semibold text-on-surface mb-2">Agreement</h4>
  <p class="text-on-surface-muted leading-relaxed">By using DSKM LMS, you agree to follow our community rules: be respectful, honest, and use the platform in ways that support learning for everyone.</p>
</section>
<section class="mb-6">
  <h4 class="text-base font-semibold text-on-surface mb-2">Account safety</h4>
  <p class="text-on-surface-muted leading-relaxed">You are responsible for keeping your password private. Do not share your login with others. Tell a teacher or administrator right away if you think your account was used without your permission.</p>
</section>
<section class="mb-6">
  <h4 class="text-base font-semibold text-on-surface mb-2">Acceptable use</h4>
  <p class="text-on-surface-muted leading-relaxed">You agree not to try to break into the system, bypass security, or interfere with other users. When you use the AI Assistant, use it to <strong class="font-semibold text-on-surface">support</strong> your lessons and understanding—not to create inappropriate or harmful content, and not to replace your own thinking or assigned work.</p>
</section>
<section class="mb-6">
  <h4 class="text-base font-semibold text-on-surface mb-2">AI disclaimer</h4>
  <p class="text-on-surface-muted leading-relaxed">The AI Assistant is an educational tool. Its suggestions are meant for learning and information only; they may be incomplete or mistaken. <strong class="font-semibold text-on-surface">Your teachers and school have the final say on grades and academic decisions.</strong></p>
</section>
<section class="mb-0">
  <h4 class="text-base font-semibold text-on-surface mb-2">Ownership</h4>
  <p class="text-on-surface-muted leading-relaxed">Work and files you upload stay yours. The platform's software, layout, and branding belong to DSKM LMS.</p>
</section>`;
}
